defmodule HandlerTest do
    ...
    # note that individual tests within the test case are always run serially. Setting async to true allows the test case as a whole to run in parallel with other test cases.
